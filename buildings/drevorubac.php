...
$naklady = 60000;
$naklady *= $urovenBudovy['Woodcutter'];
?>
<div id="navigation">
<h2>Woodcutter</h2>
<p>
...
<form action="construction.php?duration=<?= $casStavania ?>&cost=<?= $naklady?>&type=Woodcutter" method="post">
<input type="submit" value="Upgrade" />
</form>
</p>
</div>
<div id="local-info">
<img id="buildImg" src="Img/drevorubac.png" />
</div>
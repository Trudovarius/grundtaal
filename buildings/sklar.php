...
$naklady = 40000;
$naklady *= $urovenBudovy['Glassworks'];
?>
<div id="navigation">
<h2>Glassworks</h2>
<p>
...
<form action="construction.php?duration=<?= $casStavania ?>&cost=<?= $naklady?>&type=Glassworks" method="post">
<input type="submit" value="Upgrade" />
</form>
</p>
</div>
<div id="local-info">
<img id="buildImg" src="Img/sklar.png" width="255px" height="260px" />
</div>